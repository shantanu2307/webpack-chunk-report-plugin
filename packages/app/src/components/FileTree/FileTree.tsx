...
export const FileTree: React.FC<FileTreeProps> = memo(
  ({ graphData, onNodeSelect, selectedNodeId }) => {
    // State management
    ...
    const SortDirectionIcon = sortDirection === "asc" ? ArrowDown : ArrowUp;
        ...
        return (
          <div style={style} key={node.id} className="select-none">
            <div
              ...
              aria-expanded={
                hasChildren ? expandedNodes.has(node.id) : undefined
              }
            >
              {hasChildren ? (
                <button
    ...
    const toggleSortDirection = useLatestCallback(() => {
              ...
              <div className="flex gap-2">
                ...
                <div className="flex flex-row justify-between items-center pr-2">
                  <SortDirectionIcon
                    ...
                    className="absolute w-5 h-5 text-gray-400 cursor-pointer"
                  />
                </div>
              </div>
            </div>
